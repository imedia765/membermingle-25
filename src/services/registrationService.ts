...
// Create a type for member insert that excludes member_number since it's generated by a trigger
type MemberInsert = Omit<TablesInsert<'members'>, 'member_number'>;
type OptionalMemberFields = Omit<MemberInsert, keyof RequiredMemberFields>;
